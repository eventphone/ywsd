    ...
    async def _calculate_stage1_routing(self, caller, called):
        try:
            async with self._yate.routing_db_engine.acquire() as db_connection:
                ...
                routing_tree = RoutingTree(caller, called, caller_params, self._yate.settings)
            ...
            if e.error_code != "noroute":
                ...
                logging.debug("Routing {} to {} returned noroute, populate caller params and pass on"
            ...
            logging.error("An error occurred while routing {} to {}: {}\nBacktrace:".format(caller, called, e,
                                                                                            backtrace))
